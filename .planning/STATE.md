...
Last activity: 2026-07-15 - Completed quick task 260715-gji: Endpoint admin-only para ajuste livre de saldo/fichas (verified against live DB, incl. concurrency proof)
...
| 260715-gji | Endpoint admin-only POST /api/users/:id/balance para ajustar livremente saldo/fichas de qualquer usuario (credit/debit), com transacao + FOR UPDATE lock + wallet_transactions (type=correction) + audit_logs atomicos, motivo obrigatorio, guard de saldo insuficiente antes do UPDATE, sem cap artificial, auto-ajuste permitido, notificacoes fora de escopo | 2026-07-15 | f07980c | Verified | [260715-gji-permitir-que-administradores-ajustem-liv](./quick/260715-gji-permitir-que-administradores-ajustem-liv/) |
