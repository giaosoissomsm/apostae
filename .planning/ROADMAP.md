...
- [ ] 02-04-PLAN.md — Core transaction: wagerService.cashoutWager (lock-then-revalidate, formula, idempotent persistence, audit) + computation/validation tests
...
| 2. Partial Cashout | 3/7 | In Progress|  |
